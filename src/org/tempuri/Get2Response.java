...
public class Get2Response  implements java.io.Serializable {
    private java.lang.String[] get2Result;

    public Get2Response() {
    }

    public Get2Response(
           java.lang.String[] get2Result) {
     ...
     * @return get2Result
     */
    public java.lang.String[] getGet2Result() {
        return get2Result;
    }
     ...
     * @param get2Result
     */
    public void setGet2Result(java.lang.String[] get2Result) {
        this.get2Result = get2Result;
    }
        ...
        _equals = true && 
            ((this.get2Result==null && other.getGet2Result()==null) || 
             (this.get2Result!=null &&
              java.util.Arrays.equals(this.get2Result, other.getGet2Result())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGet2Result() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGet2Result());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGet2Result(), i);
                if (obj != null &&
