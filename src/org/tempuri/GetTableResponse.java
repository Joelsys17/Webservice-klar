...
public class GetTableResponse  implements java.io.Serializable {
    private java.lang.Object[] getTableResult;

    public GetTableResponse() {
    }

    public GetTableResponse(
           java.lang.Object[] getTableResult) {
     ...
     */
    public java.lang.Object[] getGetTableResult() {
        return getTableResult;
    }
     ...
     */
    public void setGetTableResult(java.lang.Object[] getTableResult) {
        this.getTableResult = getTableResult;
    }
        ...
        _equals = true && 
            ((this.getTableResult==null && other.getGetTableResult()==null) || 
             (this.getTableResult!=null &&
              java.util.Arrays.equals(this.getTableResult, other.getGetTableResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetTableResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getGetTableResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getGetTableResult(), i);
                if (obj != null &&
