...
public class GetResponse  implements java.io.Serializable {
    private org.tempuri.GetResponseGetResult getResult;

    public GetResponse() {
    }

    public GetResponse(
           org.tempuri.GetResponseGetResult getResult) {
     ...
     * @return getResult
     */
    public org.tempuri.GetResponseGetResult getGetResult() {
        return getResult;
    }
     ...
     * @param getResult
     */
    public void setGetResult(org.tempuri.GetResponseGetResult getResult) {
        this.getResult = getResult;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((this.getResult==null && other.getGetResult()==null) || 
             (this.getResult!=null &&
              this.getResult.equals(other.getGetResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getGetResult() != null) {
            _hashCode += getGetResult().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">>GetResponse>GetResult"));
